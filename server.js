    ...
    if (kind === "heading") {
      ...
      if (sec.multiline) {
        ...
        if (mode === "filled" && fid === "signature") {
          ...
          page.drawText("[initial|req|signer1]", { x: M + lw + 2, y: underY + 2, size: 7, font: font, color: white });
        } else if (val) {
